    ...
    return (
        <>
            ...
            >
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {services.map((service, index) => {
                            ...
                            return (
                                <div
                                    key={service.id}
                                    className="p-6 bg-white rounded-2xl shadow-sm border border-gray-100 transition duration-300 hover:shadow-md hover:-translate-y-0.5"
                                >
                                    <div className="h-12 w-12 rounded-xl bg-blue-50 text-blue-700 flex items-center justify-center mb-5 font-bold text-lg">
                                    ...
                                    {/* Optional image */}
                                    {image && (
                                        <div className="w-full h-48 rounded-xl overflow-hidden mt-5 border bg-gray-50">
                                            <img
                                                src={`/storage/${image}`}
                                                alt={service.title}
              ...
              {/* FOOTER */}
                <footer className="py-10 text-center text-sm text-gray-500 flex flex-col items-center justify-center gap-3">
                    <div>
                        © {new Date().getFullYear()} Higrotek Renewable Energy. All rights reserved.
                    </div>
                    
                    <a 
                        href="https://www.linkedin.com/company/higrotek-energy-solutions/" 
                        target="_blank" 
